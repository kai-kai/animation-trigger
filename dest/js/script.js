    ...
    value: function main(array, type) {
      ...
      array.forEach(function (obj) {
        if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object') {
          var elmArr = obj.elm.nodeType === 1 ? [obj.elm] : arrayFrom(obj.elm, function (e) {
            return e;
          });
          ...
          for (var i = 0; i < elmArr.length; i++) {
            ...
            if (type === 'scroll') {
              ...
              var _scrollVal = _winHeight - _winHeight / 3;
...
},{"array-from":1}],4:[function(require,module,exports){
'use strict';
